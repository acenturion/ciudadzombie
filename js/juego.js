...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 760, 500, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 860, 500, 30, 30, 1),

    new Obstaculo('imagenes/valla_horizontal.png', 100, 30, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 70, 30, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 130, 30, 30, 30, 1),  
    new Obstaculo('imagenes/valla_horizontal.png', 160, 30, 30, 30, 1),



    new Obstaculo('imagenes/valla_vertical.png', 150, 480, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 150, 450, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 420, 370, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 420, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 420, 460, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 420, 490, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 420, 430, 30, 30, 1),



    new Obstaculo('imagenes/bache.png',160,300,30,30,1),
    new Obstaculo('imagenes/bache.png',300,400,30,30,1),
    new Obstaculo('imagenes/bache.png',500,120,30,30,1),


    new Obstaculo('imagenes/auto_verde_abajo.png',90,470,15,30,1),
    new Obstaculo('imagenes/auto_verde_derecha.png',100,490,30,15,1),
    new Obstaculo('imagenes/auto_verde_abajo.png',800,400,15,30,1),

    new Obstaculo('imagenes/auto_verde_abajo.png',550,460,15,30,1),
    new Obstaculo('imagenes/auto_verde_abajo.png',515,135,15,30,1)
  ],
  ...
  enemigos: [           
    ...
    new ZombieCaminante("imagenes/zombieHDh.png", 500, 80, 30, 30, 0.5, {desdeX: 400, hastaX: 600 , desdeY: 1, hastaY: 250}),
    new ZombieCaminante("imagenes/zombieHDh.png", 500, 400, 30, 30, 1, {desdeX: 150, hastaX:  500, desdeY: 390, hastaY: 450}),
    new ZombieCaminante("imagenes/zombieHDh.png", 400, 210, 30, 30, 0.5, {desdeX: 300, hastaX: 550 , desdeY: 200, hastaY: 250}),
    new ZombieCaminante("imagenes/zombieHDv.png", 75, 55, 30, 30, 0.5, {desdeX: 70, hastaX: 90 , desdeY: 70, hastaY: 400}),
    new ZombieCaminante("imagenes/zombieHDv.png", 820, 250, 30, 30, 1, {desdeX: 770, hastaX: 850 , desdeY: 100, hastaY: 500}),
  
    new ZombieConductor("imagenes/tren_horizontal.png", 400, 325, 90, 30, 1.5, {desdeX: 15, hastaX: 900 , desdeY: 1, hastaY: 1,direccion:"h"}),
    new ZombieConductor("imagenes/tren_vertical.png", 644, 12, 30, 90, 1.5, {desdeX: 790, hastaX: 961 , desdeY: -100, hastaY: 590,direccion:"v"}),
    new ZombieConductor("imagenes/tren_vertical.png", 678, 500, 30, 90, 1.5, {desdeX: 790, hastaX: 961 , desdeY: -100, hastaY: 580,direccion:"v"})
...
Juego.iniciarRecursos = function() {
  Resources.load([
    ...
    'imagenes/zombieHDv.png',
    'imagenes/zombieHDh.png'
...
document.addEventListener('keydown', function(e) {
  ...
  /*con este if arreglo un mensaje que aparecia si 
  apretaba cualquier tecla antes de iniciar el juego*/
